        ...
        <div id="wrapper">
                ...
                <div id="box">
                    ...
                    <form id="form" action="newPaciente.php" method="post">
                      ...
                      <fieldset id="opt">
                        ...
                        <input name="idFisio" id="idFisio" type="number" value="<?php echo $_SESSION["username"] ?>" 
                        ...
                        <br />
						<label for="modoFuncional">Permite modo Funcional?: </label>
						<select name="modoFuncional" id="modoFuncional" 
                        tabindex="12" required>
							<option value=""></option>
                        ...
                        <input name="maxInt" id="maxInt" type="number" min="0" max="40" tabindex="12" required /> (mA)
                      </fieldset>
                      <div align="center">
            ...
            <div id="sidebar">
                  ...
                  <li><h3><a href="#" class="online">Navegação</a></h3>
          				<ul>
                            <li><a href="index.php" class="back">Voltar</a></li>
                        </ul>
                    </li>
				</ul>       
          </div>
